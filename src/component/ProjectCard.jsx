...
function ProjectCard() {
    ...
    return (
        <div className="grid grid-cols-3 mt-[89px] justify-items-center mb-[282px]">
        {dataProject.map((item, i) => (
        <div className="">    
            <div className="bg-[#F7F9FE] saturate-0 px-[25px] py-[25px] rounded-[30px] transition ease-in-out hover:-translate-y-1 hover:scale-110 duration-300 hover:saturate-100">
                    <img src={item.image} alt="project1" className="w-[342px] h-[257px] rounded-[20px]"/>
